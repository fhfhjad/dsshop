...
class UserModel extends RelationModel{
	...
	protected $_link=array(
		'money'=> array(  
            ...
            'foreign_key'=>'uid',
            'mapping_name'=>'money',
			'mapping_fields'=>'total_money,available_funds,freeze_funds,regular,due_in,stay_still,stay_interest,make_interest,make_reward,overdue',
			'as_fields'=>'total_money:total_money,available_funds:available_funds,freeze_funds:freeze_funds,due_in:due_in,stay_still:stay_still,stay_interest:stay_interest,make_interest:make_interest,make_reward:make_reward,overdue:overdue,regular:regular',
		),
